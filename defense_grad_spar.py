...
parser.add_argument('--target_idx', type=int, default=70, help='target sample index')
...
parser.add_argument('--out_dir', type=str, default='./defense_spar_cifar10', help='dir of output')
...
if args.dataset == "cifar10":
    ...
    test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=False,drop_last=True,num_workers=2)
...
if args.resume==False:
    logger = Logger(os.path.join(args.out_dir, "xxx"+str(args.compress_rate)+'_'+str(args.thre)+'_s'+str(args.seed)+'_log_'+str(args.num)+"_"+str(args.poison_num)+"_"+str(args.target_idx)+"_"+args.dataset+"_"+args.net+'_badnets.txt'), title="Clean")
